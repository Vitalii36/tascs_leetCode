...
even). Alice likes her candies very much, and she wants to eat the maximum number of different types of candies while still following the doctor's advice.
...
class Solution:
    def distributeCandies(self, candyType: List[int]) -> int:
        ...
        len_candy = len(candyType)
        return set_candy if set_candy < (len_candy // 2) else (len_candy // 2)
